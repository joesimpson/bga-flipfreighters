 ...
 * states.inc.php
 *
 * FlipFreighters game states description
 *
 */
...
$machinestates = array(
    ...
    2 => array(
        ...
        12 => array(
            ...
            "action" => "stPlayerturn",
            "args" => "argPlayerTurn",
            "possibleactions" => array("getPossibleLoads","getPossibleActionsForCard", "loadTruck", "moveTruck","moveMultiTrucks", "showScoringDialog","cancelTurn", "endTurn" ),
            "updateGameProgression" => true,
