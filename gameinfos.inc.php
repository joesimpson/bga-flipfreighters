...
'game_name' => "Flip Freighters",

// Game designer (or game designers, separated by commas)
'designer' => 'Wayne D Koenig',       

// Game artist (or game artists, separated by commas)
'artist' => 'Wayne D Koenig, Lorenzo Uccheddu',         

// Year of FIRST publication of this game. Can be negative.
'year' => 2022,                 

// Game publisher (use empty string if there is no publisher)
'publisher' => 'Koenig Kreations',                     

// Url of game publisher website
'publisher_website' => 'https://boardgamegeek.com/boardgamepublisher/51063',   

// Board Game Geek ID of the publisher
'publisher_bgg_id' => 51063,
...
'tie_breaker_description' => totranslate("Number of delivered trucks"),
...
'presentation' => array(
    totranslate("This Flip and Fill (roll and write) game has players taking on the role of a freight company owner. Over the course of three weeks(rounds) players will seek to load their trucks with good and deliver them to their customers. The earlier you deliver, the more you get paid, so time is of the essence. Will you send truck that are not fully loaded, or will you wait and see if you can fill a truck all the way up? The choice is yours."),
    totranslate("Each turn players will flip over 3 cards from a standard playing deck and use the cards to either load their trucks, or move them. Some trucks take certain goods (suits) and not others, while some trucks care more about the amount of goods (number on the card). Once you have decided a truck is full enough use the value on a card to move it, by marking off spaces on its path. However trucks in transit may not be loaded anymore, so choose wisely."),
    totranslate("At the end of each week all trucks that are delivered will score, while trucks in transit count for nothing. Plan your moves wisely as waiting too long could mean a lower payout than you were hoping for."),
    totranslate("Game ends after 3 rounds each with 5 turns. Players total up money earned from all 3 weeks and the player with the most money wins. In the event of a tie the player with the most delivered trucks wins."),
//    totranslate(" "),
),
